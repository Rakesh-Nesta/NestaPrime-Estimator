...
def _create_project(client, headers, client_id, **overrides):
    fields = {
        ...
        # this file's math is about Q.2 per-document overrides, not
        # regional pricing, so a non-neutral city (e.g. Mumbai) would
        # silently distort every expected total here.
