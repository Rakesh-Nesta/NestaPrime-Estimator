...
def _create_project(client, headers, client_id, **overrides):
    fields = {
        ...
        # this file's math is about K.1 step 4A tender overheads (DLP
        # reserve, BOCW cess), not regional pricing, so a non-neutral city
        # (e.g. Mumbai) would silently distort every expected total here.
